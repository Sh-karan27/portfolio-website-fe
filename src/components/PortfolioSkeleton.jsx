...
function SkeletonSection() {
  return (
    <div className="mx-auto grid max-w-[960px] gap-8 border-t border-line px-8 py-[60px] md:grid-cols-[120px_1fr]">
...
function PortfolioSkeleton() {
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-bg text-ink">
      <div className="mx-auto max-w-[960px] px-8 pb-[70px] pt-[100px]">
