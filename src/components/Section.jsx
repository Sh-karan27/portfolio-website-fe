...
function Section({ id, number, label, decoration, children, wide = false }) {
  const revealRef = useReveal()

  return (
    <section
      id={id}
      className={`relative mx-auto ${wide ? 'max-w-[1280px]' : 'max-w-[960px]'} border-t border-line px-5 py-[60px] sm:px-8`}
    >
      {decoration}
